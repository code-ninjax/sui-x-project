    ...
    <div className="w-full max-w-md mt-6 sm:mt-10">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-white/60">
          ...
          <Link href="/signup" className="text-[#C0E6FF] hover:underline">Sign up</Link>
        </p>
      </div>
      <p className="text-sm text-white/60 mb-8">Access your account.</p>
      ...
      <form className="space-y-4">
        <label className="block">
          ...
          <div className="relative">
            ...
            <input type="email" className="w-full rounded-full bg-[#030F1C] border border-white/30 px-12 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#C0E6FF]" />
          </div>
        </label>
        ...
        <label className="block">
          ...
          <div className="relative">
            ...
            <input type="password" className="w-full rounded-full bg-[#030F1C] border border-white/30 px-12 py-3 text-white focus:outline-none focus:ring-2 focus:ring-[#C0E6FF]" />
          </div>
        </label>
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <Link href="#" className="text-[#C0E6FF] hover:underline">forget password?</Link>
        </div>

        <button type="submit" className="w-full rounded-full bg-[#C0E6FF] text-[#030F1C] font-semibold py-3 hover:brightness-95 transition">Continue</button>
      </form>
